...
- [GPA Calculator](https://github.com/mueezejaz/uaf_gpa_cal) — built it for my uni. Also hooked it up to my terminal so I can check my GPA right from the command line.
